...
Isadmin=$(curl -sS https://raw.githubusercontent.com/csvpndev/taikucing/main/mek | grep $MYIP | awk '{print $5}')
...
Exp=$(curl -sS https://raw.githubusercontent.com/csvpndev/taikucing/main/mek | grep $MYIP | awk '{print $3}')
fi
...
echo -e ""
echo -e "\033[1;97mOrder AutoScript Lifetime wa.me/6283831678849\e[0m"
echo -e ""
echo -e ""
